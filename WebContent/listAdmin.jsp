...
<!-- faq-banner -->
	<div class="faq">
		<h4 class="latest-text w3_faq_latest_text w3_latest_text">LISTA DE PELÍCULAS ORDENADAS ALFABÉTICAMENTE</h4>
			<div class="container">
							...
							<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
								<div class="agile-news-table">
									...
									<table id="table-breakpoint">
										...
										String[] s={"A","B","C","D","E","F","G","H","I","J","K","L","M","N","Ñ","O","P","Q","R","S","T","U","V","W","X","Y","Z"};
											ArrayList<Pelicula> p;
											
										for(int j=0; j<s.length;j++){
				
											p = dataPel.getByInicial(s[j]); 
											for(Pelicula pel: p){
										 ...
										 %>
										  ...
										  <tr>
											...
											<td><%= pel.getAnio() %></td>
											<td class="w3-list-info"><a href="ListaPeliculasAdmin.jsp"><%=pel.getPais() %></a></td>
											<td class="w3-list-info"><a href="ListaPeliculasAdmin.jsp"><%= pel.getGenero().getDenominacion() %></a></td>
										  </tr>
										  	<% }
											}
	   									%>
